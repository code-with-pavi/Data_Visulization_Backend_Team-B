...
The Flask backend includes MongoDB-powered event search, CSV export, PDF threat
reports, threat timelines, top targeted assets, country heatmap data, expanded
analytics, request logging, consistent error handling, and environment-based
configuration. See `docs/API_DOCUMENTATION.md` for the endpoint contract.
